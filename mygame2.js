...
console.log(`Both combatants pulling their weapon results in a stand-off. Combatants cannot be harmed while dodging.\n\n`);


        let gameStart = false;
        gameStart = readlineSync.keyInYN("Are you ready to take back your Treasure?") 
...
if (gameStart === true){ // if player says 'y', game will start
    ...
    console.log("Very well. Come back when you're ready.");
        ...
        function firstGame (userInput){
        userInput = readlineSync.questionFloat("\n\nWhat do you want to do?\nFire[1], Reload[2], Take cover[3]\n\n");
